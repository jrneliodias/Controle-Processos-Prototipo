%% Controle Proporcional Integral Sintonizado por Astrom and Hagglund
...
%% Parâmetros do modelo FOPDT de Smith
...
Kp1 = 0.94*tausmith1/(Kpsmith1*thetasmith1);
Ti1 = 2*tausmith1;
Td1 = 0.5*tausmith1;
...
Kp2 = 0.94*tausmith2/(Kpsmith2*thetasmith2);
Ti2 = 2*tausmith2;
Td2 = 0.5*tausmith2;
